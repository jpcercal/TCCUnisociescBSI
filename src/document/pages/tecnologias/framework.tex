...
Na opinião de \citeonline{zendFramework2ByExampleBeginnersGuide}, dentre as
principais novidades desta nova versão se comparada a primeira \textit{release}
do \textit{framework} estão:
