...
fornecer uma abstração de tarefas que são comuns entre os sistemas, sendo que,
...
\citeonline{zendFramework2ByExampleBeginnersGuide} apresenta as principais
novidades desta nova versão do \textit{framework} desenvolvido pela \acs{Zend} 
comparando-o com a primeira \textit{release}, são elas:
