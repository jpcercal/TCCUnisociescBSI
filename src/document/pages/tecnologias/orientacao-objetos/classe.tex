...
Em uma analogia ao processo de preparação de um bolo, tem-se a classe como
sendo a receita do bolo e o objeto como sendo o próprio bolo. Com base em
uma receita é possível fazer vários bolos.

Para \citeonline{c++Absoluto}, uma classe é um novo tipo de dados, assim como os
já existentes tipos primitivos: \textit{int} e \textit{double}, portanto, um método
