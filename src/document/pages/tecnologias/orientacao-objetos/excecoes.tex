...
um erro de processamento não deixasse de interromper a execução

poderia
haver uma cor inexistente e quando esta fosse informada um erro seria gerado e
manipulado através de um blogo \textit{try/catch}.
