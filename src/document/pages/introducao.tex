...
unificar as respostas do grupo de discussão oferecendo uma interface web e 
permitir que o candidato realize um simulado de acordo com o banco de questões.
...
Enquanto que, o capítulo \ref{zcpe} apresenta o que é a prova de certificação
\acl{ZCPE}, um breve histórico das versões anteriores a esta
prova e quem é a ZEND.
...
%O sexto capítulo apresenta o desenvolvimento do sistema, demonstrando a 
%especificação e requisitos da ferramenta, arquitetura, tecnologias e protótipos
% de telas da ferramenta, explicando todas as funcionalidades que foram criadas no 
%âmbito do desenvolvimento do sistema. 

%O sétimo capítulo conclui o presente trabalho apresentando os resultados do 
%desenvolvimento do sistema, respondendo as questões de pesquisa e propondo 
