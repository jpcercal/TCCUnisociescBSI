...
que, um exemplo disto é um diploma \cite{dicionarioEscolar}.
...
A \acs{Zend} é uma empresa que atua com \acs{PHP} e fornece a seus clientes soluções 
...
\cite{websiteZendCompany}. 

Enquanto que, perante a comunidade de software, busca
...
Coreia do Norte, Sudão e Síria \cite{websiteZendZFC}. Sendo que, a lista de
locais disponíveis para a realização do exame pode ser encontrada no website
desta entidade.
...
que perante o seu entendimento geraram dúvidas, para que possam ser revistas
pouco antes da finalização do exame, afim de administrar melhor o tempo
fornecido para a conclusão da prova \cite{entrevistaAriZCEBrasil}.
...
Perante o mercado, como o escopo do \acs{PHP} é muito abrangente, as grandes empresas
...
Afim de facilitar o entendimento, a seguir será apresentado um breve histórico
...
\citeonline{entrevistaAriZCEBrasil} teve seu conteúdo revisado e incrementado,
