...
A seguir apresenta-se a especificação dos requisitos de software para a
ferramenta proposta, lembrando que, a definição dos requisitos teve a
colaboração dos próprios participantes da lista de discussão ``Rumo à
Certificação PHP''.
...
\begin{alineas}
    ...
    \item o sistema deverá redirecionar os usuários que não tiverem permissão à
    ...
    cadastro manual da pergunta por um usuário da aplicação;
