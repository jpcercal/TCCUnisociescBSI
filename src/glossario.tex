...
\acro{bug}[bug]{\textit{funcionamento comum de um software, ou ainda, falha lógica de um programa}}
...
\acro{Zend Studio}[Zend Studio]{\textit{IDE baseada no projeto eclipse voltada ao
